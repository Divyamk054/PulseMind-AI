    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          <p className="text-gray-500 text-sm mb-6">Sign in to your healthcare dashboard</p>
          ...
          <div className="mt-5 pt-5 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="py-2 text-xs bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg border border-gray-700 transition-all"
              >
                Patient Demo
              </button>
              <button
                onClick={() => demoLogin("admin")}
                className="py-2 text-xs bg-purple-900/40 hover:bg-purple-900/60 text-purple-300 rounded-lg border border-purple-700/30 transition-all"
              >
                Admin Demo
              </button>
            </div>
